...
define("antie/widgets/widget", [
   ...
   */
  return Class.extend(
    /** @lends antie.widgets.Widget.prototype */ {
      /**
       * @constructor
       * @ignore
       */
      ...
      render: function render(/*device*/) {
        throw new Error(
          "Widget::render called - the subclass for widget '" +
            this.id +
            "' must have not overridden the render method."
        );
      },
      /**
          ...
          for (var func in listeners) {
            if (listeners.hasOwnProperty(func)) {
              try {
                ...
                var logger = this.getCurrentApplication()
                  .getDevice()
                  .getLogger();
                logger.error(
                  "Error in " +
      ...
      show: function(options) {
        if (this.outputElement) {
          ...
          throw new Error(
            "Widget::show called - the current widget has not yet been rendered."
          );
        }
      },
      /**
      ...
      hide: function(options) {
        if (this.outputElement) {
          ...
          throw new Error(
            "Widget::hide called - the current widget has not yet been rendered."
          );
        }
      },
      /**
      ...
      moveTo: function(options) {
        if (this.outputElement) {
          ...
          throw new Error(
            "Widget::moveTo called - the current widget has not yet been rendered."
          );
        }
      }
    }
