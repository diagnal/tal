...
define("antie/widgets/componentcontainer", [
   ...
   */
  var ComponentContainer = Container.extend(
    /** @lends antie.widgets.ComponentContainer.prototype */ {
      /**
       * @constructor
       * @ignore
       */
       ...
       */
      _loadComponentCallback: function _loadComponentCallback(
        module,
        componentClass,
        args,
        keepHistory,
        ...
        newComponent.bubbleEvent(
          new ComponentEvent("load", this, _knownComponents[module], args)
        );
      ...
      show: function show(module, args, keepHistory, state, fromBack, focus) {
        ...
        if (_knownComponents[module]) {
          ...
          this._currentComponent.bubbleEvent(
            new ComponentEvent(
              "beforerender",
              this,
          ...
          if (!evt.isDefaultPrevented()) {
            ...
            var animate =
              !config.widgets ||
              !config.widgets.componentcontainer ||
              config.widgets.componentcontainer.fade !== false;
            device.showElement({
              el: this._currentComponent.outputElement,
              skipAnim: !animate
            });
          ...
          self._currentComponent.bubbleEvent(
            new ComponentEvent(
              "aftershow",
              self,
          ...
          if (!focusRemoved) {
            ...
            self
              ...
              .getLogger()
              .warn(
                "active component is not currently focusable",
                self._activeChildWidget
              );
          }
        } else {
          ...
          require([module], function(componentClass) {
            ...
            if (
              self._loadingModule === module &&
              self._loadingIndex === loadingIndex
            ) {
              self._loadComponentCallback(
                module,
                componentClass,
                args,
                keepHistory,
      ...
      */
      ...
      back: function back() {
        var _focus;
        try {
          _focus = this._currentComponent.getIsModal()
            ? this._previousFocus
            : null;
        } catch (e) {
          _focus = null;
      ...
      hide: function hide(
        ...
        if (this._currentComponent) {
          ...
          try {
            _state = keepHistory
              ? this._currentComponent.getCurrentState()
              : null;
          } catch (e) {
            _state = null;
          }
        ...
        if (this._isFocussed && focusToComponent) {
          this.parentWidget.setActiveChildWidget(
            this.parentWidget._childWidgets[focusToComponent]
          );
        }
      },
